...
*Code contributed*: +
link:https://github.com/CS2103AUG2017-T17-B2/main/tree/master/collated/main/Jeremy.md[Functional code] +
link:https://github.com/CS2103AUG2017-T17-B2/main/tree/master/collated/test/Jeremy.md[Test code] +
